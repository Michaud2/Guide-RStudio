...
Pour suivre les exemples qui seront présentés dans ce guide, vous pouvez importer la base de données en format **.dta (STATA)** qui est hébergée sur mon DropBox personnel via le lien suivant en faisant un copier coller (SANS GUILLEMETS) dans la console lorsque ce sera demandé, ou en l'ajoutant directement comme valeur de l'argument data : <https://dimension.usherbrooke.ca/donnees/base2015CES.csv>

```{r base_importer, eval = FALSE}

base = importer("https://dimension.usherbrooke.ca/donnees/base2015CES.csv")
# OU
