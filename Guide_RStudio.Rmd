...
Avant de croiser ces deux variables, on se doit de vérifier leurs valeurs afin de voir s'il faut procéder à un recodage. On peut vérifier leurs valeurs selon les méthodes présentées à la section [Analyse univariée][univar].
...
## *Une variable indépendante qualitative et une dépendante quantitative*
...
Comme d'habitude, il faut vérifier les valeurs possibles des variables afin de voir s'il faut procéder à un recodage. On peut vérifier leurs valeurs selon les méthodes présentées à la section [Analyse univariée][univar].
